                    ...
                    <ul>
                        <li>
                            <a href="{{ route('products.index') }}"
                                class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ request()->routeIs('products.*') ? 'active' : '' }}"
                                data-tip="products">
                        ...
                        <li>
                            <a href="{{ route('authors.index') }}"
                                class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ request()->routeIs('authors.*') ? 'active' : '' }}"
                                data-tip="Authors">
                        ...
                        <li>
                            <a href="{{ route('categories.index') }}"
                                class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ request()->routeIs('categories.*') ? 'active' : '' }}"
                                data-tip="Categories">
                        ...
                        <li>
                            <a href="{{ route('publications.index') }}"
                                class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ request()->routeIs('publications.*') ? 'active' : '' }}"
                        ...
                        <li>
                            <a href="{{ route('racks.index') }}"
                                class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ request()->routeIs('racks.*') ? 'active' : '' }}"
                                data-tip="Racks">
            ...
            <li>
                <details>
                    <summary class="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                        ...
                        <span class="is-drawer-close:hidden">Stock Management</span>
                    </summary>
                    <ul>
                        <li>
                            <a href="{{ route('vendors.index') }}"
                                class="is-drawer-close:tooltip is-drawer-close:tooltip-right {{ request()->routeIs('vendors.*') ? 'active' : '' }}"
                                data-tip="vendors">
                                ...
                                <span class="is-drawer-close:hidden">Vendors</span>
                            </a>
                        </li>
